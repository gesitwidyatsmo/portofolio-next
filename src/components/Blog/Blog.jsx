...
const Blog = () => {
	return (
		<section
			id='blog'
			className='py-10 lg:py-20 px-4 bg-darkprimary dark:bg-slate-600'>
			<div className='flex flex-col text-center justify-center items-center mx-auto text-white relative'>
				...
				<motion.div
					...
					viewport={{ once: true }}>
					<Link
						href='https://www.geswatech.com/'
						target='_blank'
						className='mt-7 bg-primary py-3 px-5 border-2 flex justify-center items-center rounded-full cursor-pointer'>
